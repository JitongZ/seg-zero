    ...
    for guidance_steps in tqdm(guidance_steps_list):
        for mask_outside_scaling_factor in tqdm(mask_outside_scaling_factors):
            for mask_inside_scaling_factor in tqdm(mask_inside_scaling_factors):
                for mask_dim_threshold in tqdm(threshold_list):
                    ...
                    if args.masks is None:
                        ...
                        dest_file = os.path.join(args.results_folder, f"edit/{bname}_{args.task_name}_guidance_{guidance_steps}_{args.xa_guidance}_outside_{mask_outside_scaling_factor}_inside_{mask_inside_scaling_factor}_threshold_{mask_dim_threshold}.png")
                    ...
                    for inv_path, prompt_path in zip(l_inv_paths, l_prompt_paths):
                        ...
                        rec_pil, edit_pil = pipe(prompt_str,
                                ...
                                mask_dim_threshold=mask_dim_threshold,
